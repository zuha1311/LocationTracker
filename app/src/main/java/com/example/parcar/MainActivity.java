...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendToDatabase(final double la, final double lo) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (!snapshot.child("Location").exists()) {
                    ...
                    userDataMap.put("lat",String.valueOf(la));
                    userDataMap.put("long",String.valueOf(lo));

                    RootRef.child("Location").updateChildren(userDataMap)
